      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-conservation text-white px-6 py-4 rounded-2xl shadow-lg">
              <div className="text-center">
                <div className="text-2xl font-bold">250+</div>
                <div className="text-sm opacity-90">Local Jobs Created</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="section-subtitle mb-6">
                Enkop, meaning "earth" in the Maasai language, represents our deep connection 
                to this ancient land. Here, luxury meets responsibility, creating experiences 
                that nurture both soul and environment.
              </p>
